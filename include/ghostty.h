...
void ghostty_surface_screenshot(ghostty_surface_t, const char*);
bool ghostty_surface_text_dump(ghostty_surface_t,
                               uint8_t format,
                               const uint8_t** out_ptr,
                               uintptr_t* out_len);
void ghostty_surface_free_dump(const uint8_t* ptr, uintptr_t len);
